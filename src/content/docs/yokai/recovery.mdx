...
Yokai retries failed work automatically. Leave recovery enabled to let it diagnose a failed Build or repair unfinished bookkeeping. Watch the recovery activity in the [TUI](/docs/yokai/tui); use [troubleshooting](/docs/reference/troubleshooting) if the run stops.
...
- [Run](/docs/yokai/run): `--max-cost`, halt conditions
- [Build loop](/docs/yokai/build): iterations, judge, `FEEDBACK.md`
- [Troubleshooting](/docs/reference/troubleshooting): recovery symptom rows
