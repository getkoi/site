...
Save these choices after human approval through the helper or CLI. It inherits durable guides, timeouts and sandbox
...
use after status, plan or scope edits. Reconsider them with `/yokai assess` or explicit `yokai assess`
