...
[Run your first phase](/koi/docs/quickstart). You can return here for the architecture and terminology.
...
| Goal | Start here |
|------|------------|
| Install and run your first project | [Quickstart](/koi/docs/quickstart) |
| Learn the junji method verb by verb | [junji hub](/junji/docs) → [Guide](/junji/docs/guide) |
| Install or invoke the agent skills | [junji skills reference](/junji/docs/skills) |
| Run phases unattended | [yokai hub](/yokai/docs) → [Run](/yokai/docs/run) |
| Copy a verification script | [Recipes](/yokai/recipes) |
| Wire the verification bar | [Sensors](/yokai/docs/sensors) |
| Run inside a Linux VM sandbox | [Sandbox overview](/yokai/docs/sandbox) |
| Understand Plan → Build → Seal | [Build](/yokai/docs/build) |
| Understand recovery | [Recovery](/yokai/docs/recovery) |
| Deep glossaries and ADRs | [Reference glossaries](/koi/docs/glossary) and [decision records](/koi/docs/decisions) |
